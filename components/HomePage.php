...
<html lang="en">
  ...
  <body>
    <div class="HomePageMain">
      <div class="HomeMenu"> 
        <button class="btn btn1" onclick="location.href='../pages/Feed.php'">
        ...
        <button class="btn btn2" onclick="location.href='../pages/Profile.php'">
        <span style="padding-right:3px; padding-top: 8px; display:inline-block;">
            <img class="profImage" src="../assets/images/profile.png" alt="Perfil"></img>
          </span>  
        </button>
        <button class="btn btn3" onclick="location.href=''">
        <span style="padding-right:3px; padding-top: 8px; display:inline-block;">
