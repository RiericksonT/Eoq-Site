...
<p>A sua privacidade é importante para nós. É política do É o que? respeitar a sua privacidade em relação a qualquer
    informação sua que possamos coletar no site <a href=dhyell.com.br>É o que?</a>, e outros sites que possuímos e
    operamos.</p>
...
<h2>Política de Cookies É o que?</h2>
...
<p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o É o que? oferece no site e com
    caráter enunciativo, mas não limitativo:</p>
<ul>
    <li>A) Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem pública;</li>
    <li>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, ou apostas desportivas (ex.:<a
            href="https://ondeapostar.pt/review/moosh-portugal/"> Moosh</a>), jogos de sorte e azar, qualquer tipo de
        pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;</li>
    <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do É o que?, de seus fornecedores ou
...
<p>Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se precisa
    ...
    site.</p>
<p>Esta política é efetiva a partir de <strong>July</strong>/<strong>2021</strong>.</p>
</div>
';
